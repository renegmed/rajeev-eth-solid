...
contract('Calculator', function(accounts) {
  ...
  it("should assert true", async () => {
    ...
    result = await Calculator.deployed().then(function(instance){
      calculator = instance;
      return calculator.getResult.call();
    });   
  ...
  it("should add 10 and then substract 5 to get a result=15", async () => {
    // Get the deployed instance
    var calculator;
    ...
    assert.equal(result.toNumber(), 20, "Result after adding 10 should be 20");
      ...
      // Now substract 10
    await calculator.substractNumber(5);
